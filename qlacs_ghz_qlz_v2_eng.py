...
# ⚙️ Call to external HARPIA binary (Rust)
...
def run_simulation(num_qubits, total_frames=100000, noise_prob=0.01):
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    run_simulation(num_qubits=qubits, total_frames=frames, noise_prob=0.01)